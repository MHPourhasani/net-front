...
const TrashIcon = ({ onClick, color, className }: IIconProps) => {
    return (
        <svg width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={className}>
            <rect width="20" height="24" fill="#E5E5E5" />
            <g id="Light Outline">
                <rect x="-257" y="-657" width="1760" height="1011" rx="80" fill="white" />
                <g id="Delete">
                    <path
                        id="Squircle"

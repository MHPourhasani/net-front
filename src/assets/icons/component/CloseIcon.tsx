...
const CloseIcon = ({ onClick, className }: IIconProps) => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={className}>
            ...
            />
            <path d="M15 9L12 12M12 12L9 15M12 12L15 15M12 12L9 9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};

        ...
        <div className="flex flex-col">
            ...
            >
                ...
                {showOptions && !props.disabled && (
                    <div
                        className={`no-scrollbar absolute z-10 flex h-fit max-h-96 w-full flex-col overflow-y-auto rounded-b-lg border border-t-0 border-sky-500 bg-white text-gray-900 shadow-md`}
                    >
